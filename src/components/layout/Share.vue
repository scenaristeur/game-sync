...
export default {
  ...
  props: {
    item: Object,
    default: {url: "https://scenaristeur.github.io/game-sync", name: "GameSync, InterPlanetaryGraphSystem"},
    variant: {
      type: String,
      default: "danger"
    },
  ...
  data(){
    return {
      it: {},
      sharing: {
        url: 'https://scenaristeur.github.io/game-sync',
        title: 'Game-Sync.',
        description: 'Check out this game-sync graph.',
        quote: 'Best way to easily share your thought',
        hashtags: 'GameSync,InterPlanetaryGraphSystem,ipgs,decentralized,Solid,nodejs,vuejs',
  ...
  methods: {
    async share(){
      ...
      // .then(json => {
      //   console.log(json)
      this.sharing.url = this.it.url != undefined ? 'https://scenaristeur.github.io/game-sync/?url='+this.it.url : "https://scenaristeur.github.io/ipgs"
      this.sharing.description = 'Check out this Game-sync graph :'+this.it.name
